let logger = require('@sex-pomelo/sex-pomelo-logger').getLogger('pomelo-rpc', 'MailStation');
let EventEmitter = require('events').EventEmitter;
let blackhole = require('./mailboxes/blackhole');
let defaultMailboxFactory = require('./mailbox');
